  ...
  const downloadInvoice = (invoice: any) => {
    ...
    import("jspdf").then(({ jsPDF }) => {
      try {
        ...
        if (logoData !== "LOGO_BASE64_PLACEHOLDER") {
        ...
        if (sigData !== "SIG_BASE64_PLACEHOLDER") {
